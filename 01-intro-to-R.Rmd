...
The data files for this workshop are found in this [GitHub repository](https://github.com/bstaton1/au-r-workshop-data). Go [here](#data-sets) for details. Navigate to this repository, download the file `streams.csv` and place it in your working directory for this session. This chapter assumes your working directory is `C:/Users/YOU/Documents/R-Workshop/Chapter1`, though the one you are actually using may be slightly different (the `YOU` should at least be changed for your computer). You can read the contents of `streams.csv` into R using this code (ensure your working directory is set **first**):
