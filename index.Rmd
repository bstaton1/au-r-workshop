...
The second version was written through R and RStudio using the R packages `{rmarkdown}` and `{knitr}` **CITE**, which allowed the integration of text, code, and output all into one output file. This was completed in Fall 2015. Like the first version, individual session materials were created in separate documents. 
