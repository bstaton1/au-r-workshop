...
Download the data set `sockeye.csv` from the [GitHub repository](https://github.com/bstaton1/au-r-workshop-data) (or go [here](#data-sets) for details) and place it in your working directory. This is the same data set you used in [Exercise 2](#ex2) - revisit this section for more details on the meaning of the variables.
...
First, aquire the `feeding.csv` data set from the [GitHub repository](https://github.com/bstaton1/au-r-workshop-data) (or go [here](#data-sets) for details) and place it in your working directory. Read the data into R: 
