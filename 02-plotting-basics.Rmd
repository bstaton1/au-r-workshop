...
Table `r if(is_html_output()) "\\@ref(tab:plot-arg-table-html)" else "\\@ref(tab:plot-arg-table-pdf)"` are just a handful of them to get you started.
...
```{r plot-arg-table-pdf, ech = F, eval = is_latex_output()}
pars = c("xlab", "ylab", "main", "cex", "pch", "xlim", "ylim", "type",
         "lty", "lwd", "col")
