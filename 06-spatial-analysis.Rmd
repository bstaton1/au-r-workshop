...
Now that your points have been turned into tracks for each bear, see where they intersect using the `gIntersection()` function from the `{rgeos}` package. Hang on though, this will take your computer a while to run (between 5 and 20 minutes). You can start a timer as well:
