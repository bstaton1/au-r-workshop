...
Go to _File > New File > R Script_. This will create an untitled R script. Go the _File > Save_, give it the appropriate name and click _Save_. If your working directory is already set to `C:/Users/YOU/Documents/R-Workshop/Chapter 1`, then the file will be saved there by default.
...
After downloading `ponds.csv` to your working directory and creating `Ex1B.R`, 
