...
and was last built on 10-01-2018.
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-76-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-97-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-99-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-101-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-122-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-129-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-134-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-140-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-142-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-146-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-161-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-166-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-173-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-185-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-187-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-189-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-196-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-197-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-204-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-223-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-230-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-234-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-240-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-245-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-251-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-254-1} \end{center}
...
{\centering \includegraphics[width=11.24in]{bear} 

}

\caption{Henry, you want to draw a picture to go here?}\label{fig:bear}
\end{figure}
...
\KeywordTok{install.packages}\NormalTok{(}
  ...
  \StringTok{"adehabitatHR"}\NormalTok{,}\StringTok{"dismo"}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}

You will need \texttt{\{dplyr\}} as well, if you did not install it
already for Chapter \ref{ch5}.
...
{\centering \includegraphics{au-r-workshop_files/figure-latex/vector-types-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# how many records of each bear are there?}
\KeywordTok{table}\NormalTok{(bear}\OperatorTok{$}\NormalTok{ID)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# bears that were relocated fewer than 5 times }
\CommentTok{# cannot be used in future analysis so filter them out}
\KeywordTok{library}\NormalTok{(dplyr)}
\NormalTok{bear =}\StringTok{ }\NormalTok{bear }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(ID) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{n}\NormalTok{() }\OperatorTok{>=}\StringTok{ }\DecValTok{5}\NormalTok{)}

\CommentTok{# now how many bears are there?}
\KeywordTok{unique}\NormalTok{(bear}\OperatorTok{$}\NormalTok{ID)}
\end{Highlighting}
\end{Shaded}
...
Now, use the \texttt{\{sp\}} package to create a spatial object out of
your standard R data frame. You can think of this object like a
\textbf{layer} in GIS. \texttt{\{sp\}} lets you create layers with or
without attribute tables, but if your spatial data have other attributes
like an ID or a timestamp variable, you should always create an object
with class \texttt{SpatialPointsDataFrame} to make sure those
...
The \texttt{\{rgdal\}} package facilitates loading spatial data files
(i.e., shapefiles) into R. The function \texttt{readOGR()} takes a
standard shapefile (\texttt{.shp}), and converts it into a the correct
spatial object (e.g., points vs.~polygons). It takes two arguments: the
data source name (\texttt{dsn}, the directory), and the layer name
(\texttt{layer}). When you download a shapefile from an open-source web
portal, it will often have accompanying files that store the attribute
data. Store all of these files in a folder with the same name as the
shapefile. Now load in the shapefile that contains a polygon for the
boundary of Slovenia \citep{svn-cite} from the directory, so you can see
where in the country the brown bears were detected:
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-268-1} \end{center}

The \texttt{alpha()} function from the \texttt{\{scales\}} package
allows you to plot with transparent colors, which is helpful for seeing
the high- versus low-density clusters. Now, plot your reference layers
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-269-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-271-1} \end{center}
...
apply a function to plot each bear's detected movement trajectory on a
separate map. Wrap your code inside of a new PDF device (described in
Section \ref{file-devices}) so you can scroll through the plots
separately:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pdf}\NormalTok{(}\StringTok{"Relocations.pdf"}\NormalTok{, }\DataTypeTok{h =} \DecValTok{5}\NormalTok{, }\DataTypeTok{w =} \DecValTok{5}\NormalTok{)}
\KeywordTok{sapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(bear}\OperatorTok{$}\NormalTok{ID), }\ControlFlowTok{function}\NormalTok{(id) \{}
  \KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{))}
  \KeywordTok{plot}\NormalTok{(stats, }\DataTypeTok{border =} \StringTok{"grey"}\NormalTok{, }\DataTypeTok{axes =}\NormalTok{ T,}
       \DataTypeTok{xlim =}\NormalTok{ bear}\OperatorTok{@}\NormalTok{bbox[}\DecValTok{1}\NormalTok{,],  }\CommentTok{# access the boundary box using @}
       \DataTypeTok{ylim =}\NormalTok{ bear}\OperatorTok{@}\NormalTok{bbox[}\DecValTok{2}\NormalTok{,], }\DataTypeTok{main =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Bear:"}\NormalTok{, id))}
  \KeywordTok{plot}\NormalTok{(slovenia, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{, }\DataTypeTok{add =}\NormalTok{ T)}
  \KeywordTok{points}\NormalTok{(bear[bear}\OperatorTok{$}\NormalTok{ID }\OperatorTok{==}\StringTok{ }\NormalTok{id,], }\DataTypeTok{type =} \StringTok{"o"}\NormalTok{, }\DataTypeTok{pch =} \DecValTok{16}\NormalTok{, }\DataTypeTok{cex =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{col =} \KeywordTok{alpha}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\FloatTok{0.5}\NormalTok{))}
  \KeywordTok{plot}\NormalTok{(railways, }\DataTypeTok{add =}\NormalTok{ T, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{)}
\NormalTok{\})}
\KeywordTok{dev.off}\NormalTok{()}
\end{Highlighting}
...
the bear data to the extent of Slovenia.
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-275-1} \end{center}

\subsection{Adding Attributes}\label{adding-attributes}

What if you wanted to add an attribute to a points object, like which
polygon it occurs in? In order to figure out how many bear relocations
were documented in each statistical region of Slovenia, you'll have to
merge the two objects.

\textbf{DOES SOMETHING ELSE GO HERE??}

\section{Analysis}\label{Anal}

Now that you know how to import, plot, and manipulate your data, it's
time to do some analysis. The \texttt{\{rgeos\}} package has a few tools
for simple geometric calculations like finding the distance between two
points, or the area of a polygon. However, more specialized analyses are
often only available in other packages. One commonly used package in
animal ecology is the \texttt{\{adehabitat\}} package suite. Use this
package in conjunction with \texttt{\{rgeos\}} to determine where the
tagged bears may have crossed the railroad.
...
Now, plot the homeranges of each bear, label them, and overlay the
railroad on a map.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#rgeos has a few nice functions for plotting and spatial transformations}
\KeywordTok{library}\NormalTok{(rgeos) }
\CommentTok{#match the coordinate system of the home ranges object with the railways layer }
\NormalTok{cp =}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(cp, }\KeywordTok{CRS}\NormalTok{(}\KeywordTok{proj4string}\NormalTok{(slovenia)))}
\NormalTok{railways =}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(railways, }\KeywordTok{CRS}\NormalTok{(}\KeywordTok{proj4string}\NormalTok{(slovenia)))}
\CommentTok{#keep only the homeranges that include some part of the railway}
\NormalTok{cp =}\StringTok{ }\NormalTok{cp[railways,] }

\CommentTok{# plot the polygons}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(cp,}\DataTypeTok{col=}\KeywordTok{alpha}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\FloatTok{0.5}\NormalTok{), }\DataTypeTok{axes =}\NormalTok{ T)}
\CommentTok{#rgeos has a bunch of neat functions like this one}
\KeywordTok{polygonsLabel}\NormalTok{(cp, }\DataTypeTok{labels =}\NormalTok{ cp}\OperatorTok{$}\NormalTok{id, }\DataTypeTok{method =} \StringTok{"buffer"}\NormalTok{,}
              \DataTypeTok{col =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{doPlot=}\NormalTok{T) }
\KeywordTok{lines}\NormalTok{(railways, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{,}\DataTypeTok{col =} \StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-277-1} \end{center}
...
which is stored as a script file in your working directory. If you ever
write a function, you can store it in a script file, and then bring it
into your current session using the \texttt{source()} function. This
prevents you from needing to paste all the function code every time you
want to use it in a new script. Save as many functions as you want in a
single script, and they will all be added to your Global Environment
when you \texttt{source()} the file\footnote{For projects with many
  user-defined functions, you may be better off creating a
  \texttt{./Functions} directory and housing multiple scripts there.
  Better yet, you can create your own package for personal use. Look
  into the \texttt{\{devtools\}} and \texttt{\{roxygen2\}} packages}.
...
computer a while to run (between 5 and 20 minutes). You can start a
timer as well:
...
\KeywordTok{Sys.time}\NormalTok{() }\OperatorTok{-}\StringTok{ }\NormalTok{start}
\end{Highlighting}
\end{Shaded}

\section{Creating a Presentable Map}\label{PresentMap}

Now that you have a points object with the crossings stored, make a map
that you can present to policy makers.

\textbf{THIS PART DOESN'T WORK FOR ME, SEE THE ISSUE}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(dismo)}
\KeywordTok{library}\NormalTok{(raster) }\CommentTok{#the basemap will be stored as a raster object.}
\NormalTok{basemap =}\StringTok{ }\KeywordTok{gmap}\NormalTok{(bear, }\DataTypeTok{exp=}\DecValTok{1}\NormalTok{, }\DataTypeTok{type=}\StringTok{"terrain"}\NormalTok{, }\DataTypeTok{lonlat =}\NormalTok{ T)}
\KeywordTok{plot}\NormalTok{(basemap)}
\CommentTok{#reproject each layer to the coordinate system of the basemap.}
\NormalTok{bear <-}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(bear, basemap}\OperatorTok{@}\NormalTok{crs)}
\NormalTok{railways <-}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(railways, basemap}\OperatorTok{@}\NormalTok{crs)}
\NormalTok{slovenia <-}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(slovenia, basemap}\OperatorTok{@}\NormalTok{crs)}
\KeywordTok{proj4string}\NormalTok{(crossings) <-}\StringTok{ }\NormalTok{basemap}\OperatorTok{@}\NormalTok{crs}
\KeywordTok{points}\NormalTok{(bear,}\DataTypeTok{col=}\StringTok{"white"}\NormalTok{,}\DataTypeTok{pch=}\DecValTok{15}\NormalTok{,}\DataTypeTok{cex=}\NormalTok{.}\DecValTok{5}\NormalTok{)}
\NormalTok{railways <-}\StringTok{ }\KeywordTok{crop}\NormalTok{(railways,basemap)}
\KeywordTok{plot}\NormalTok{(railways,}\DataTypeTok{add=}\NormalTok{T,}\DataTypeTok{lwd=}\DecValTok{4}\NormalTok{,}\DataTypeTok{col=}\StringTok{"yellow"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(crossings,}\DataTypeTok{add=}\NormalTok{T,}\DataTypeTok{col=}\StringTok{"red"}\NormalTok{,}\DataTypeTok{cex=}\DecValTok{1}\NormalTok{,}\DataTypeTok{pch=}\DecValTok{16}\NormalTok{)}
\KeywordTok{box}\NormalTok{()}
\CommentTok{#scalebar(5000,xy=click(),col="white")}
\CommentTok{#legend?}
\CommentTok{#labels?}
\CommentTok{#arrows?}
\end{Highlighting}
...
of the railroad that get the most bear activity. Add arrows pointing to
where you think the crossings should go.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(slovenia)}
\KeywordTok{plot}\NormalTok{(railways, }\DataTypeTok{add =}\NormalTok{ T, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(crossings, }\DataTypeTok{add =}\NormalTok{ T, }\DataTypeTok{pch =} \DecValTok{17}\NormalTok{, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-284-1} \end{center}
...
Just like for \texttt{\{ggplot2\}}, many R users find the
\texttt{\{ggmap\}} package more intuitive than creating maps with
\texttt{plot()} like you have done in this chapter. Here's an example:
...
\KeywordTok{geocode}\NormalTok{(}\StringTok{"United States"}\NormalTok{)}
\KeywordTok{qmap}\NormalTok{(}\DataTypeTok{location =} \StringTok{"boston university"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\subsection{\texorpdfstring{\texttt{\{leaflet\}}}{\{leaflet\}}}\label{leaflet}

This package allows you to make interactive maps. This will only work if
your output is HTML-based\footnote{If you're viewing this in PDF format,
  go to:
  \url{https://bstaton1.github.io/au-r-workshop/ch6.html\#leaflet} to
  view the interactive version. Better yet, install
  \texttt{\{leaflet\}}, and try it yourself!}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(leaflet)}
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#add a basemap}
\StringTok{  }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Esri.WorldGrayCanvas, }\DataTypeTok{group =} \StringTok{"Grey"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# change the initial zoom}
\StringTok{  }\KeywordTok{fitBounds}\NormalTok{(slovenia}\OperatorTok{@}\NormalTok{bbox[}\StringTok{"x"}\NormalTok{,}\StringTok{"min"}\NormalTok{], slovenia}\OperatorTok{@}\NormalTok{bbox[}\StringTok{"y"}\NormalTok{,}\StringTok{"min"}\NormalTok{],}
\NormalTok{            slovenia}\OperatorTok{@}\NormalTok{bbox[}\StringTok{"x"}\NormalTok{,}\StringTok{"max"}\NormalTok{], slovenia}\OperatorTok{@}\NormalTok{bbox[}\StringTok{"y"}\NormalTok{,}\StringTok{"max"}\NormalTok{]) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# fill in slovenia}
\StringTok{  }\KeywordTok{addPolygons}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ slovenia, }\DataTypeTok{color =} \StringTok{"grey"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# draw the railroad}
\StringTok{  }\KeywordTok{addPolylines}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ railways,}\DataTypeTok{opacity =} \DecValTok{1}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# draw the relocations}
\StringTok{  }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ bear, }\DataTypeTok{color =} \StringTok{"blue"}\NormalTok{, }\DataTypeTok{clusterOptions =} \KeywordTok{markerClusterOptions}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# draw the crossing events}
\StringTok{  }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ crossings, }\DataTypeTok{color =} \StringTok{"yellow"}\NormalTok{, }\DataTypeTok{clusterOptions =} \KeywordTok{markerClusterOptions}\NormalTok{())}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Load the \texttt{caves.shp} shapefile from your working directory
  \citep{caves-cite}. Add the data to one of the maps of Slovenia you
...
\tightlist
\item
  \textless{}HELPFUL.WEBSITE.\#1\textgreater{}
\item
  \textless{}HELPFUL.WEBSITE.\#2\textgreater{}
\item
  \textless{}HELPFUL.WEBSITE.\#3\textgreater{}
\item
  \textless{}HELPFUL.WEBSITE.\#4\textgreater{}
\end{itemize}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-325-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-329-1} \end{center}
...
\KeywordTok{mean}\NormalTok{(rolls }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{6}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-339-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-342-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-344-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ricker_sim}\NormalTok{(}\DataTypeTok{ny =} \DecValTok{20}\NormalTok{, }
           \DataTypeTok{params =} \KeywordTok{c}\NormalTok{(}\DataTypeTok{alpha =} \DecValTok{6}\NormalTok{,}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-348-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-350-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-354-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-355-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-355-2} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-370-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{dat =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"../Data/growth.csv"}\NormalTok{)}
\NormalTok{dat =}\StringTok{ }\NormalTok{dat[dat}\OperatorTok{$}\NormalTok{age }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{),]}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-377-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-388-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-390-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-392-1} \end{center}
