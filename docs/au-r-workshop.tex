...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-100-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{), }\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{), }\DataTypeTok{oma =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{))}
...
\NormalTok{\})}
\KeywordTok{mtext}\NormalTok{(}\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{outer =}\NormalTok{ T, }\DataTypeTok{line =} \FloatTok{1.5}\NormalTok{, }\StringTok{"Frequency"}\NormalTok{, }\DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-103-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-109-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-118-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-138-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-154-1} \end{center}
...
\addcontentsline{toc}{subsection}{Exercise 3 Bonus}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-165-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-181-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-183-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-211-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-212-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-214-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-216-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-226-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-228-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-256-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-263-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-267-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(sp)}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-274-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-281-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-283-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-292-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-307-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-309-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-313-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-319-1} \end{center}
...
Just like for \texttt{\{ggplot2\}} \citep{R-ggplot2}, many R users find the \texttt{\{ggmap\}} \citep{R-ggmap} package more intuitive than creating maps with \texttt{plot()} like you have done in this chapter. If you have messed around with \texttt{\{ggplot2\}} or would like a slightly different plotting workflow, look into it more.

\hypertarget{leaflet}{%
\subsection{\texorpdfstring{\texttt{\{leaflet\}}}{\{leaflet\}}}\label{leaflet}}

The \texttt{\{leaflet\}} package \citep{R-leaflet} allows you to make interactive maps. This will only work if your output is HTML-based\footnote{If you're viewing this in PDF format, go to: \url{https://bstaton1.github.io/au-r-workshop/ch6.html\#leaflet} to view the interactive version. Better yet, install \texttt{\{leaflet\}}, and try it yourself!}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-368-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-372-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-381-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-382-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-385-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-387-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-391-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-393-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-397-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-398-2} \end{center}

\hypertarget{ex4e-answers}{%
\subsection*{Exercise 4E Solutions}\label{ex4e-answers}}
\addcontentsline{toc}{subsection}{Exercise 4E Solutions}

\textbf{1. Replicate the bootstrap analysis but adapted for the linear regression example in Section \ref{regression}. Stop at the step where you summarize the 95\% interval range.}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-413-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-420-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-431-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-433-1} \end{center}
...
\textbf{Bonus 2. Plot the time series of age composition by sex and year. Does it look like age composition has changed over time?}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-435-1} \end{center}
...
\begin{center}\includegraphics{au-r-workshop_files/figure-latex/unnamed-chunk-439-1} \end{center}
